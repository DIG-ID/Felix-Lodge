<section id="section-previews" class="section-previews lg:pb-40 lg:pt-0 bg-white overflow-hidden">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-12 gap-x-6 px-14 pt-8 pb-52">
        ...
        <div class="col-span-1 lg:col-span-3 lg:col-start-9 flex justify-center items-center flex-col">
            <div>
                ...
                <a href="<?php the_field('section_previews_button_link_1'); ?>" class="btn-primary text-button !leading-9"><span class="pt-0"><?php esc_html_e( 'Mehr Erfahren', 'felixlodge' ) ?></span></a>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-12 gap-x-6 px-14 py-8">
