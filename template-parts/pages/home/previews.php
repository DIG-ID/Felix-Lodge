<section id="section-previews" class="section-previews xl:pb-40 xl:pt-0 px-5 lg:px-16 xl:px-14 bg-white overflow-hidden">
    ...
    <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-12 gap-5 lg:gap-4 xl:gap-8 pt-8 pb-32 xl:pb-52">
    ...
    <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-12 gap-5 lg:gap-4 xl:gap-8 py-16 xl:py-8">
