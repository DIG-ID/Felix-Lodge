<section id="section-activities" class="section-activities bg-white overflow-hidden px-5 lg:px-16 xl:px-14">
    ...
    <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-12 gap-5 lg:gap-4 xl:gap-8 pt-0 pb-20 xl:pb-40">
    ...
    <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-12 gap-5 lg:gap-4 xl:gap-8 pt-0 pb-40 xl:pb-80">
