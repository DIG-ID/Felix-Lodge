<section id="section-activities" class="section-activities bg-white overflow-hidden container-margins">
    <div class="container-grid pt-20 xl:pt-40">
        ...
        <div class="col-span-4 md:col-span-5 xl:col-span-5 md:col-start-4 xl:col-start-7 grid grid-cols-1 xl:grid-cols-5 gap-5 lg:gap-4 xl:gap-8 order-1 xl:order-2">
            <h2 class="title-big col-span-1 xl:col-span-5 mb-8 md:mb-16 xl:mb-0"><?php the_field( 'section_activities_title_1' ); ?></h2>
    ...
    <div class="container-grid pt-14 md:pt-20 xl:pt-40">
        <div class="col-span-3 col-start-2 md:col-start-6 xl:col-start-2 md:-mt-[27rem] lg:-mt-[33rem] xl:mt-0">
            <p class="text-body xl:!mb-16"><?php the_field( 'section_activities_description_1' ); ?></p>
            <a href="<?php the_field('section_activities_button_link_1'); ?>" class="btn-primary mb-16 md:mb-20 xl:mb-0"><?php esc_html_e( 'Mehr Erfahren', 'felixlodge' ); ?></a>
        </div>
    ...
    <div class="container-grid pt-0 pb-20 xl:pb-40">
		...
		<div class="col-span-3 md:col-span-4 xl:col-span-3 md:col-start-5 xl:col-start-8">
    ...
    <div class="container-grid pt-0 pb-40 xl:pb-80">
        <div class="col-span-3 md:col-span-4 xl:col-span-4 xl:col-start-3 pb-14 md:pb-0">
            <?php 
        ...
        <div class="col-span-3 md:col-span-3 xl:col-span-3 col-start-2 md:col-start-6 xl:col-start-8 flex flex-col justify-end">
