<section id="section-previews-more" class="section-previews-more px-5 lg:px-16 xl:px-14 bg-white overflow-hidden">
    ...
    <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-12 gap-5 lg:gap-4 xl:gap-8 pb-40">
        <div class="col-span-3 md:col-span-4 xl:col-span-4 xl:col-start-2">
            <?php 
        ...
        <div class="col-span-1 col-start-2 md:col-start-6 xl:col-start-8 flex flex-col justify-center">
            <div class="w-full max-w-[120px] border-b-2 inline-block border-black"></div>
        </div>
        <div class="col-span-2 md:col-span-2 xl:col-span-3 col-start-3 md:col-start-7 xl:col-start-9 flex flex-col justify-center hyphenate">
            <p class="title lg:max-w-xl"><?php the_field('previews_more_subtitle_2'); ?></p>
        </div>
        <div class="col-span-3 md:col-span-3 xl:col-span-3 md:col-start-2 xl:col-start-4">
            <p class="text-body pt-44"><?php the_field('previews_more_description_2'); ?></p>
        </div>
        <div class="col-span-2 md:col-span-3 xl:col-span-3 col-start-3 md:col-start-6 xl:col-start-9 -mt-10">
            <?php 
