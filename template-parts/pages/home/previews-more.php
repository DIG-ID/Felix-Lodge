<section id="section-previews-more" class="section-previews-more bg-white overflow-hidden">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-x-6 px-14 py-40">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-x-6 px-14 py-40">
        <h2 class="title-big col-span-1 lg:col-span-6 lg:col-start-5"><?php the_field('previews_more_title_2'); ?></h2>
    </div>
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-x-6 px-14 py-40">
        ...
        <div class="col-span-1 lg:col-span-4 lg:col-start-4">
